...
urlpatterns = [
    ...
    path("tipos-finalidades/", view=TipoFinalidadeView.as_view(), name="subtipo_finalidade"),
    path("tipos-finalidades/<int:pk>/", view=SingleTipoFinalidadeView.as_view(), name="single_subtipo_finalidade"),
    path("naturezas/", view=NaturezaFinalidadeView.as_view(), name="tipos_despesas"),
    path("naturezas/<int:pk>/", view=SingleNaturezaFinalidadeView.as_view(), name="single_natureza_finalidade"),

...
urlpatterns = [
    ...
    path("empenhos/montante-total/<int:pk>/", EmpenhoMontante.as_view(), name="total_empenho"),
    ...
    path("tipos-documento/", TipoDocumentoPagamentoParcialView.as_view(), name="tipos_documentos"),
    path("tipos-documento/<int:pk>/", SingleTipoDocumentoPagamentoParcialView.as_view(), name="single_tipo_documento"),
